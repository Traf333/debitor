...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { buyer_id: @operation.buyer_id, comment: @operation.comment, seller_id: @operation.seller_id, value: @operation.value }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { buyer_id: @operation.buyer_id, comment: @operation.comment, seller_id: @operation.seller_id, value: @operation.value }
    assert_redirected_to operation_path(assigns(:operation))
  end
